...
public enum ResultCode {
    ...
    SEARCH_STORES_SUCCESS("S004", "입력한 문자열을 매장명에 포함하고 있는 매장들의 정보를 조회하였습니다."),
    UPDATE_SEAT_COUNT_SUCCESS("S005", "선택하신 매장의 좌석 개수를 변경하였습니다."),
    DELETE_SPECIFIC_STORE_SUCCESS("S006", "선택하신 매장을 삭제하였습니다."),
